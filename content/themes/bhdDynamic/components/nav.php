...
<div id="fullmenu">
  <a href="" id="close-menu"><?php echo file_get_contents($GLOBALS['url']."/assets/close-bttn.svg"); ?></a>
	<div class="fullmenu">
	  ...
	  <div class="menu-link"><a href="" id="nav-about">About</a></div>
	</div>
	<div class="fullmenu">
	  <div class="menu-bg" id="menu-02">02</div>
    <div class="menu-link"><a href="" id="nav-press">Press</a></div>
	</div>
	<div class="fullmenu">
	  <div class="menu-bg" id="menu-03">03</div>
	  <div class="menu-link"><a href="" id="nav-leasing">Leasing</a></div>
	</div>
	<div class="fullmenu">
	  <div class="menu-bg" id="menu-04">04</div>
	  <div class="menu-link"><a href="" id="nav-connect">Connect</a></div>
	</div>
</div>
